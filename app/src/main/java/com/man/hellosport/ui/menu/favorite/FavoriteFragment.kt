...
class FavoriteFragment : Fragment() {
    ...
    private  fun init() {
        ...
        viewpager_favorite.adapter = object : FragmentStateAdapter(this) {
        ...
        TabLayoutMediator(tabs_favorite, viewpager_favorite) { tab, position ->
            tab.text = when (position) {
                0 -> "Favorite Last Match"
                else -> "Favorite Next Match"
            }
        }.attach()
    }
}